            ...
            if (key.getKeyType() == KeyType.ArrowUp)
                ...
                switch (sel) {
                    ...
                    case 1 -> DBAdmin.executeAndDisplay(screen,
                            "SELECT * FROM transactions WHERE agentId = " + userId + " AND transactionType = 'sale'",
                            "My Sales");
                    case 2 -> DBAdmin.executeAndDisplay(screen,
                            "SELECT * FROM transactions WHERE agentId = " + userId + " AND transactionType = 'rent'",
                            "My Rentals");
                    case 3 -> DBAdmin.executeAndDisplay(screen,
                            "SELECT u.name, u.email, u.phoneNumber, a.experienceYears, a.salary, a.rating, a.dealCount, a.rentCount " +
